...
const MoveDictionary: React.FC<Props> = ({_visible }) => {
        ...
        Object.keys(moves).forEach(move => options.push(<Option _value={move} />))
...
//         <Option _value='Select a Move'></Option>,
//     ]
//     const select = <select onChange={displayMove}>{options}</select>

//     function displayMove() {
//         setDefinition(moves['Session End'])
//     }

//     Object.keys(moves).forEach((move) => 
//         options.push(<Option _value={move}></Option>)
//     )

//     if (!_visible) classes.push('hidden')

//     return (
//         <form name='move-dictionary' className={classes.join(' ')}>
//             <h1>Move Dictionary</h1>
//             <label form='move-dictionary'>
//                 {select}
//             </label>
//             <section className='move-definition'>{definition.join(' \n')}</section>
//         </form>
//     )
// }
